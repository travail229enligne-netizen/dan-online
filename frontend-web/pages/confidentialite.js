    ...
    <>
      ...
      <main className="container" style={{ paddingTop: 24, paddingBottom: 60 }}>
        ...
        <p style={{ fontSize: 13, color: "var(--ink-soft)", marginBottom: 24 }}>
          Cette politique explique quelles données Shopyz collecte, pourquoi, et comment elles sont protégées.
        </p>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div style={card}>
            ...
            <p style={p}>
              Lors de la création de ton compte et de l'utilisation de Shopyz, nous collectons :
          ...
          <div style={card}>
            ...
            <p style={p}>
              Cette politique peut évoluer avec le développement de Shopyz. Toute mise à jour
