...
const faqs = [
  {
    q: "Comment fonctionne Shopyz ?",
    a: "Shopyz est une marketplace qui réunit des boutiques, restaurants, supermarchés, grossistes et artisans partenaires au Bénin. Tu parcours les produits, tu commandes, et la boutique concernée prépare et organise la livraison chez toi.",
  },
  {
  ...
  },
  {
    ...
    a: "Chaque boutique organise sa livraison, soit avec son propre livreur, soit en confiant la course à un livreur du réseau Shopyz. Dans les deux cas, tu peux suivre l'avancement et échanger directement avec le livreur via la messagerie.",
  },
  {
  ...
  {
    q: "Comment devenir marchand sur Shopyz ?",
  ...
  {
    q: "Shopyz prend-il une commission sur les ventes ?",
  ...
  },
  {
    ...
    a: "Les revenus d'une boutique s'accumulent dans son portefeuille Shopyz au fur et à mesure des commandes livrées et payées. Le marchand peut ensuite demander un retrait vers son compte Mobile Money.",
  },
  {
    ...
    <>
      ...
      <main className="container" style={{ paddingTop: 24, paddingBottom: 60 }}>
        ...
        <p style={{ fontSize: 14, color: "var(--ink-soft)", marginBottom: 24 }}>
          Les réponses aux questions les plus fréquentes sur Shopyz.
        </p>
