        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div style={card}>
            ...
            <p style={{ fontSize: 14, color: "var(--ink-soft)", lineHeight: 1.6, margin: 0 }}>
              EasyShop est né d'une idée simple : rassembler la richesse et la diversité des marchés béninois,
          ...
          <div style={card}>
            ...
            <p style={{ fontSize: 14, color: "var(--ink-soft)", lineHeight: 1.6, margin: 0 }}>
              ...
              EasyShop fournit l'outil — recherche, paiement en ligne ou en espèces, messagerie, suivi de
