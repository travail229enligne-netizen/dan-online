      ...
      <main className="container" style={{ paddingTop: 24, paddingBottom: 60 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div style={card}>
            ...
            <p style={p}>
              La plateforme EasyShop est exploitée par une entreprise établie à Cotonou, Bénin.
            </p>
          </div>
          ...
          <div style={card}>
            ...
            <p style={p}>
              Le site et l'application EasyShop sont hébergés par des prestataires cloud tiers
          ...
          <div style={card}>
            ...
            <p style={p}>
              EasyShop est une plateforme de marketplace qui met en relation des vendeurs
              (boutiques, restaurants, supermarchés, grossistes, artisans) et des acheteurs au
              Bénin. Sauf mention contraire, EasyShop n'est pas elle-même vendeuse des produits
          ...
          <div style={card}>
            ...
            <p style={p}>
              Le nom « EasyShop », son logo, ainsi que l'ensemble des éléments graphiques et
              techniques du site (hors contenus publiés par les boutiques partenaires) sont la
              propriété d'EasyShop. Toute reproduction non autorisée est interdite.
            </p>
          </div>
        </div>
      </main>
